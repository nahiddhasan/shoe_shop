  ...
  return (
    <div className=" w-full my-6 lg:my-12 flex items-center">
      ...
      <div className=" px-4 lg:px-8 w-[1400px] mx-auto flex items-center justify-center  ">
        <div className="flex flex-col-reverse md:flex-row w-full gap-2 max-h-[800px] " >
          {/* left  */}
          <div className="flex flex-col md:flex-[2] bg-[#f2f2f2] rounded-2xl overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row gap-2 h-full lg:h-[65%]">
              {/* left side */}
              <div className="relative w-full lg:w-1/2 h-[400px] rounded-2xl overflow-hidden">
                <Image
                  src="/img/hype1.jpg"
                  fill
                  alt=""
          ...
          {/* right main*/}
          <div className="lg:flex-[1] flex flex-col justify-between rounded-2xl max-h-[800px] h-[600px] overflow-hidden bg-[#f2f2f2]">
            {/* image  */}
