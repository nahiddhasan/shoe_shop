  ...
  return (
    <div className=" w-full my-12 flex items-center">
      <div className=" px-4 lg:px-8 w-[1400px] mx-auto flex items-center justify-center  ">
        {/* main Container  */}
        <div className="p-10 w-full bg-[#f2f2f2] md:bg-[url('/img/hero.jpg')] bg-center bg-cover bg-no-repeat rounded-2xl flex items-center justify-center ">
          {/* main container */}
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col gap-4 items-center justify-center">
              <div className="flex items-center flex-col leading-snug">
                ...
                <h1 className="text-[32px] md:text-[48px] lg:text-[68px] text-center">Tropical Green</h1>
