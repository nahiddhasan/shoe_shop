  ...
  return (
    <div>
      ...
      {open && (
        <>
          <div
            className="modal__bg fixed top-0 left-0 h-screen w-screen"
            onClick={() => setOpen(false)}
          />
          <div className="fixed px-8 p-4 top-0 right-0 h-screen w-screen md:w-[40vw] bg-white z-10 box__shadow cursor-auto">
            {/* top  */}
